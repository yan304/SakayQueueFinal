...
export default function SeatManagement({back, data, backData}) {
    ...
    return <View>
            <View style={styles.backButton}>
                <Button icon='chevron-left' size={24} color="black" style={styles.backButtonStyle} onPress={back}>
                    Seat Reservation
                </Button>
            </View>
                            ...
                            {[items,items+5,items+10,items+15].map(item => (
                                <View style={{ display: "flex", flexDirection: "row", alignItems: "space-between" }}>
                                    {occupied.includes(item) ?
                                        <View style={{ backgroundColor: "#A4A3A3", height: 30, width: 35, borderRadius: 5, margin: 2}}>
                                            <Icon name='check-circle-outline' onPress={() => handleReserve(item)}/>
                                        </View>
                                        :
                                            reserved.includes(item) ?
                                                <View style={{ backgroundColor: "#F9AD10", height: 30, width: 35, borderRadius: 5, margin: 2}}>
                                                    <Icon name='check-circle-outline' onPress={() => handleSeat(item)}/>
                                                </View>
                                            :
                                    ...
                                    {occupied.includes(item + 1) ?
                                        <View style={{ backgroundColor: "#A4A3A3", height: 30, width: 35, borderRadius: 5, margin: 3}}>
                                            <Icon name='check-circle-outline' onPress={() => handleReserve(item + 1)}/>
                                        </View>
                                        :
                                            reserved.includes(item + 1) ?
                                                <View style={{ backgroundColor: "#F9AD10", height: 30, width: 35, borderRadius: 5, margin: 2}}>
                                                    <Icon name='check-circle-outline' onPress={() => handleSeat(item + 1)}/>
                                                </View>
                                            :
                                    ...
                                    {occupied.includes(item + 2) ?
                                        <View style={{ backgroundColor: "#A4A3A3", height: 30, width: 35, borderRadius: 5, margin: 3}}>
                                            <Icon name='check-circle-outline' onPress={() => handleReserve(item + 2)}/>
                                        </View>
                                        :
                                            reserved.includes(item + 2) ?
                                                <View style={{ backgroundColor: "#F9AD10", height: 30, width: 35, borderRadius: 5, margin: 2}}>
                                                    <Icon name='check-circle-outline' onPress={() => handleSeat(item + 2)}/>
                                                </View>
                                            :
                                    ...
                                    <View style={{ display: "flex", flexDirection: "row", alignItems: "space-between", marginLeft: 50 }}>
                                        {occupied.includes(item + 3) ?
                                            <View style={{ backgroundColor: "#A4A3A3", height: 30, width: 35, borderRadius: 5, margin: 3}}>
                                                <Icon name='check-circle-outline' onPress={() => handleReserve(item + 3)}/>
                                            </View>
                                            :
                                                reserved.includes(item + 3) ?
                                                    <View style={{ backgroundColor: "#F9AD10", height: 30, width: 35, borderRadius: 5, margin: 2}}>
                                                        <Icon name='check-circle-outline' onPress={() => handleSeat(item + 3)}/>
                                                    </View>
                                                :
                                        ...
                                        {occupied.includes(item + 4) ?
                                            <View style={{ backgroundColor: "#A4A3A3", height: 30, width: 35, borderRadius: 5, margin: 3}}>
                                                <Icon name='check-circle-outline' onPress={() => handleReserve(item + 4)}/>
                                            </View>
                                            :
                                                reserved.includes(item + 4) ?
                                                    <View style={{ backgroundColor: "#F9AD10", height: 30, width: 35, borderRadius: 5, margin: 2}}>
                                                        <Icon name='check-circle-outline' onPress={() => handleSeat(item + 4)}/>
                                                    </View>
                                                :
